...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        /* Crimson Mud */
        ResourceLocation crimson_mud = new ResourceLocation(Grounded.MODID, "block/crimson_mud/crimson_mud");
        ResourceLocation polished_crimson_mud = new ResourceLocation(Grounded.MODID, "block/crimson_mud/polished_crimson_mud");
        ...
        /* Entrailite */
        ResourceLocation entrailite = new ResourceLocation(Grounded.MODID, "block/entrailite/entrailite");
        ResourceLocation entrailite_top = new ResourceLocation(Grounded.MODID, "block/entrailite/entrailite_top");
        ResourceLocation entrailite_crimson_nylium = new ResourceLocation(Grounded.MODID, "block/entrailite/entrailite_crimson_nylium");
        ResourceLocation entrailite_warped_nylium = new ResourceLocation(Grounded.MODID, "block/entrailite/entrailite_warped_nylium");
        ResourceLocation cobbled_entrailite = new ResourceLocation(Grounded.MODID, "block/entrailite/cobbled_entrailite");
        ResourceLocation polished_entrailite = new ResourceLocation(Grounded.MODID, "block/entrailite/polished_entrailite");
